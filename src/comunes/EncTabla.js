            ...
            <React.Fragment>
                <div className='row'>
                    <div className='col-lg-8 izqq '>
                        <div className="actions"><h6 className='actions'>{titul}</h6></div>
                    </div>
                    <div className='col-lg-4 derechas'>
                        <NavLink className={`${((showButton === false)?"d-none":"")} btn btn-primary`} to={link}><i className="xicon icon ion-plus-round" ></i> Agregar {titu2}</NavLink>
                    </div>
                </div>
            </React.Fragment>
        )
