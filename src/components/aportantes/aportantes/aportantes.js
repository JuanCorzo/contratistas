...
class aportanes extends Component {
  ...
  linksBreadcrumb = [{href:"inicio", name:"Inicio"}, {href:"aportantes", name:"Listado de Entidades Aportantes"}];
  componentDidMount() { }
  elimina = (id) => {
    swal({
  ...
  render() {
    ...
    const columnas = [
      {
        title: 'NIT', headerStyle: { "textAlign": "center", "padding": "0px" }, field: 'apo_identificacion', sortable: true, width: "10%",
        render: row => (
      ...
      { title: 'Entidad', headerStyle: { "textAlign": "center", "padding": "0px" }, field: 'apo_nombre', sortable: true, width: "20%" },
      { title: 'Municipio', headerStyle: { "textAlign": "center", "padding": "0px" }, field: 'ciu_nombre', sortable: true, width: "10%" },
      { title: 'Departamento', headerStyle: { "textAlign": "center", "padding": "0px" }, field: 'dep_nombre', sortable: true, width: "15%" },
      { title: 'Territorial', headerStyle: { "textAlign": "center", "padding": "0px" }, field: 'ter_nombre', sortable: true, width: "15%" },
      {
        title: 'Macrozona', headerStyle: { "textAlign": "center", "padding": "0px" }, field: 'ter_macrozona', sortable: true, width: "25%",
            ...
            <div className="card pd-20 pd-sm-20">
              {
                ...
                ) : (<h6 className="actions">Entidades Aportantes</h6>)
              }
