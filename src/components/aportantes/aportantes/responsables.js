                        ...
                        <div className="col-md-6 izqq fflitro">
                                ...
                                this.state.facs.map((con, i) => {
                                    ...
                                    return ( 
                                        <div className={color}>
                                            ...
                                            <div className="col-md-6 izqq" style={{"fontSize":"11px", "padding-top":"2px"}}>{con.est_nombre}</div>
                                            <div className="col-md-5 izqq" style={{"fontSize":"11px", "padding-top":"2px"}}>{con.est_descripcion}</div>
                                        </div>
                                    )
                                })
                            }
                            { 
                                ...
                                <div className="row fofgr">
                                    ...
                                    <div className="col-md-6 izqq" style={{"fontSize":"11px", "padding-top":"2px"}}>Soporte de modificación</div>
                                ...
                                <div class="v-line"></div>
                                {
                                    this.state.lit1.map((con, i) => {
                                        ...
                                        <div className="row">
                                            ...
                                            <div className='col-lg-6'><b>{con.nombre}</b><br></br>
                                            {con.ruta}<br></br><a href={"mailto:"+con.res_email}>{con.res_email}</a><br></br></div>
