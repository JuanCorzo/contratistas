    ...
    render() {
        ...
        const columnas = [
            ...
            { title: 'Email', field: 'res_email', sortable: true },
            {
                ...
                render: row => (<Descargado docid={row["idc"]} tipo="responsable" />)
            }
        ]
        return (
            <div>
                                        ...
                                        this.state.lit1.map((con, i) => {
                                            return (
                                                <div className="row xrow">
                                                    ...
                                                    <div className='col-lg-1'><i className="icon ion-person xiconlt nombreticon"></i></div>
                                        ...
                                        this.state.lit2.map((con, i) => {
                                            return (
                                                <div className="row xrow">
                                                    ...
                                                    <div className='col-lg-1'><Descargado docid={con.id} tipo="factores" /><br></br></div>
                                                </div>
                                            )
                                        })
                                    }
