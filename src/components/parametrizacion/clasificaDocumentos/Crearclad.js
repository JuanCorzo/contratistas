...
class Creaarrol extends Component {
    ...
    render() {
        ...
        if(this.state.status==="Ok"){ return <Redirect to="/clasificas"/>; }let linksBreadcrumb = [{href:"inicio", name:"Inicio"}, {href:"clasificas", name:"Clasificación Documentos"}, {href:"#", name:"Agregar clasificación Documentos"}];
        return (
            <div>
                <Header/>
                <Menulat/>
